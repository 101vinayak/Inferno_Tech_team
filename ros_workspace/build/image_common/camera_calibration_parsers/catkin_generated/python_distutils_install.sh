...
echo_and_run cd "/home/vinayak/ros_workspace/src/image_common/camera_calibration_parsers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/vinayak/ros_workspace/src/image_common/camera_calibration_parsers/setup.py" \
    build --build-base "/home/vinayak/ros_workspace/build/image_common/camera_calibration_parsers" \
    install \
    $DESTDIR_ARG \
