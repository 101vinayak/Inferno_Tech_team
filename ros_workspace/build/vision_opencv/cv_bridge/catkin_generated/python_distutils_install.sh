...
echo_and_run cd "/home/vinayak/ros_workspace/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/vinayak/ros_workspace/src/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/vinayak/ros_workspace/build/vision_opencv/cv_bridge" \
    install \
    $DESTDIR_ARG \
